package com.giaccneto.notificacao.business;

import com.giaccneto.notificacao.business.dto.TarefasDTO;
import com.giaccneto.notificacao.infraestructure.exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto){
        try{
            ...
            mimeMessageHelper.setTo(InternetAddress.parse(dto.getEmailUsuari()));
            mimeMessageHelper.setSubject("Notificação de tarefa ");


            Context context = new Context();
            context.setVariable("nomeTarefa", dto.getNomaTarefa());
